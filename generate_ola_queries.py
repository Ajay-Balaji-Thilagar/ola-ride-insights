# Script to generate SQL queries for OLA Ride Insights project
sql_queries = """-- File: ola_queries.sql
...
# Save to file
sql_file_path = r'A:\ajay\Labmentix_Internship\OLA_Project_7\ola_queries.sql'
